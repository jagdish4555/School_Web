...
export default function FacilityDetail() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <motion.section 
        className="relative min-h-[35vh] bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 overflow-hidden py-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        ...
        >
          <motion.h3 
            className="text-3xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-12"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
